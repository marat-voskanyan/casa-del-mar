...
// Clean SVG icons — all use currentColor, strokeWidth 1.5 (thin, elegant)
...
// Bus/Transit — replaces 🚌
export function TransitIcon({ size = 18, className = '', strokeWidth = 1.5 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24"
      fill="none" stroke="currentColor" strokeWidth={strokeWidth}
      strokeLinecap="round" strokeLinejoin="round" className={className}>
